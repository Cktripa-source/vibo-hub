    ...
    return (
        <div className="flex min-h-screen bg-gray-100">
            ...
            <main className="flex-1 ml-64 bg-gray-100">
                <div className="p-8">
                    <div className="mb-8">
                        <h1 className="text-2xl font-bold text-gray-800">Welcome back, {user?.name || 'Vendor'}!</h1>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                        <div className="bg-white p-6 rounded-xl shadow-sm">
                            ...
                            <p className="text-2xl font-semibold text-gray-800 mt-2">24</p>
                        ...
                        <div className="bg-white p-6 rounded-xl shadow-sm">
                            ...
                            <p className="text-2xl font-semibold text-gray-800 mt-2">$12,426</p>
                        ...
                        <div className="bg-white p-6 rounded-xl shadow-sm">
                            ...
                            <p className="text-2xl font-semibold text-gray-800 mt-2">64</p>
                        ...
                        <div className="bg-white p-6 rounded-xl shadow-sm">
                            ...
                            <p className="text-2xl font-semibold text-gray-800 mt-2">3.24%</p>
                            ...
                            <div className="space-y-4">
                                {[1, 2, 3].map((i) => (
                                    <div key={i} className="flex items-center p-4 bg-gray-50 rounded-lg">
                                        ...
                                        <div>
                                            <h4 className="text-sm font-medium text-gray-800">Order #{1000 + i}</h4>
                                            <p className="text-sm text-gray-500">2 items • $149.99</p>
                                        </div>
                                    </div>
                                ))}
                            </div>
